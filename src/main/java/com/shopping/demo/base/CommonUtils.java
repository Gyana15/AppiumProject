...
public class CommonUtils {
	...
	public static void loadConfigProp(String propertyFileName) throws IOException
	 {
		FileInputStream fis = new FileInputStream(System.getProperty("user.dir")+"src\\main\\java\\com\\shopping\\demo\\Resources\\app\\appProperties\\"+propertyFileName);
		prop.load(fis);
	...
	public static void setCapabilities() {
		...
		capabilities.setCapability(MobileCapabilityType.UDID, CommonUtils.APPLICATION_NAME);
